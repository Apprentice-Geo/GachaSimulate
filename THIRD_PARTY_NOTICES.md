...
- [`docs/reference/DESIGN-nvidia.md`](docs/reference/DESIGN-nvidia.md), [`docs/reference/DESIGN-sentry.md`](docs/reference/DESIGN-sentry.md), and [`docs/reference/DESIGN-vercel.md`](docs/reference/DESIGN-vercel.md): derived from the VoltAgent `awesome-design-md` collection, licensed under the MIT License. The files may contain modifications for use in GachaSimulate. The license text is in [`third_party/licenses/awesome-design-md-MIT.txt`](third_party/licenses/awesome-design-md-MIT.txt).
