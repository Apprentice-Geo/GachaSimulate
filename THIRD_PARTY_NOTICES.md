...
- [`docs/reference/DESIGN-nvidia.md`](docs/reference/DESIGN-nvidia.md) and [`docs/reference/DESIGN-sentry.md`](docs/reference/DESIGN-sentry.md): derived from the VoltAgent `awesome-design-md` collection, licensed under the MIT License. The license text is in [`third_party/licenses/awesome-design-md-MIT.txt`](third_party/licenses/awesome-design-md-MIT.txt).
