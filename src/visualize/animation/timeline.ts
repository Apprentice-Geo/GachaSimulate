...
export const ANIMATION_TIMELINE = {
  ...
  CURVE_DURATION_MS: 1000, // CDF 阶梯曲线绘制持续时间
  MARKER_LINE_DELAY_MS: 1800, // 分位数竖向标注线开始出现的时间
  MARKER_LINE_DURATION_MS: 300, // 分位数竖向标注线伸展持续时间
  MARKER_GROUP_DELAY_MS: 2200, // 分位数标注点和文字开始浮现的时间
  MARKER_GROUP_DURATION_MS: 300, // 分位数标注点和文字浮现持续时间
  MARKER_STAGGER_MS: 50, // 各分位数标注之间的错峰间隔
  MEAN_LINE_DELAY_MS: 2500, // MEAN 横向虚线开始出现的时间
  MEAN_LINE_DURATION_MS: 300, // MEAN 横向虚线伸展持续时间
  TERMINATION_PANEL_DELAY_MS: 2500, // 终止条件卡片开始浮现的时间
  TERMINATION_PANEL_DURATION_MS: 400, // 终止条件卡片浮现持续时间
  PK_FILL_DELAY_MS: 3000, // 终止条件 PK 条开始填充的时间
  PK_FILL_DURATION_MS: 400, // 终止条件 PK 条填充持续时间
  TERMINATION_DETAIL_DELAY_MS: 3200, // 终止原因图例开始浮现的时间
  TERMINATION_DETAIL_DURATION_MS: 200, // 终止原因图例浮现持续时间
  STAT_PANEL_DELAY_MS: 3400, // 核心统计量背景卡片开始浮现的时间
  STAT_PANEL_DURATION_MS: 300, // 核心统计量背景卡片浮现持续时间
  STAT_CONTENT_DELAY_MS: 3800, // 核心统计量列表内容开始自上而下浮现的时间
  STAT_CONTENT_DURATION_MS: 200, // 单个统计量标题或卡片浮现持续时间
