...
async function handle_visualize_input_request(
  ...
  try {
    ...
    send_json_response(response, 404, { error: `无法读取 input 文件：${message}` });
  }
}
